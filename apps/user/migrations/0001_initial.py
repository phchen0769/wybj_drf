    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_menu', models.ForeignKey(blank=True, help_text='上级菜单', null=True, on_delete=django.db.models.deletion.SET_NULL, to='user.menu', verbose_name='上级菜单')),
            ],
            options={
                'verbose_name': '菜单',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu', models.ForeignKey(help_text='菜单', on_delete=django.db.models.deletion.CASCADE, to='user.menu', verbose_name='菜单')),
            ],
            options={
                'verbose_name': '权限',
